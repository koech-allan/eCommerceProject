...
urlpatterns = [
    ...
    path('about/', user_views.about, name='about-page'),
    path('add-product/', user_views.add_product, name='add-product-page'),
    path('products/', user_views.products, name='all-products'),
    path('student/', user_views.student, name='student-page'),
    path('student-detais/', user_views.student_details, name='students-details-page'),
    path('delete-product/<id>', user_views.delete_product, name='del-pr'),
    path('update-product/<id>', user_views.update_product, name='update-prod'),
